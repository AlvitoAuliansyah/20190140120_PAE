...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String pekerjaan, String warganegara, String berlakuhingga) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
    ...
    public String toString() {
        return "KTP.Tugas_120.Data[ id=" + id + " ]";
    }
